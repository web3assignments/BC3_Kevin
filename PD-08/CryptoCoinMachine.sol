...
contract CryptoCoinMachine is Ownable {
    ...
    function SetOracle(address _address) public onlyOwner { oracle = address(_address); }
    ...
    function CCMachineBalance() public view returns (uint) { return address(this).balance; }
    ...
    function SelfDestruct() public payable onlyOwner { selfdestruct(msg.sender); }
}
